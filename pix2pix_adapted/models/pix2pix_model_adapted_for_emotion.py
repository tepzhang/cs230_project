...
class Pix2PixModel_for_emotion(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_L1', 'D_real', 'D_fake', 'D_emo_loss']
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        self.visual_names = ['real_A', 'fake_B', 'real_B']
        # specify the models you want to save to the disk. The training/test scripts will call <BaseModel.save_networks> and <BaseModel.load_networks>
        if self.isTrain:
            self.model_names = ['G', 'D', 'D_emo']
    ...
    def backward_G(self):
        ...
        # Third, add the loss from the emotion discriminator
        emotion_pred = self.netD_emo(self.fake_B)
        emotion_target = self.netD_emo(self.real_A)
        self.loss_D_emo_loss = self.criterion_D_emo(emotion_pred, emotion_target) * self.opt.lambda_emo
        # combine loss and calculate gradients
        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_D_emo_loss
